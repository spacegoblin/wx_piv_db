...
def importFile(FILE):
    ...
    for row in reader:
       ...
       if i==0:
           ...
           new_datev.soll = row[6].replace('.', '').replace(',', '.')
           ...
           new_datev.imp_str = unicode("Salary-%s"%random_str, errors='ignore')
           ...
           contra_datev.imp_str = unicode("Salary-%s"%random_str, errors='ignore')
...
if __name__=='__main__':
    ...
    importFile('L:\\Reporting\\2014\\11-Nov\\LSE\\v01\\imp.csv')
